...
namespace RestProject.Controllers
{
    public class StaffsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,LastName,FirstName,Mail,Password,HireDate,Manager_ID,Department_ID")] Staff staff)
        {
            try
            {
        ...
        public ActionResult EditPost(int? id)
        {
            ...
            if (TryUpdateModel(staffToUpdate, "",
               new string[] { "LastName", "FirstName", "Mail","Password", "HireDate", "Manager_ID", "Department_ID" }))
            {
                try
                {
                    db.SaveChanges();
